...
public struct LevelParams
{
    ...
    public float lowSpdMaxHealth;
    public float midSpdMaxHealth;
    public float highSpdMaxHealth;

    public float midSpdMaxRatio;
    public float highSpdMaxRatio;
...
public class LevelManager : MonoBehaviour
{
    ...
    public LevelParams[] allLevelParams;
    public static LevelParams curParams;
    private int i = -1;
    public int[] number;
    public float curLevelTime = 0f;
    ...
    void InitLevel()
	{
        curParams = allLevelParams[level - 1];
        curLevelTime = 0f;
    }
